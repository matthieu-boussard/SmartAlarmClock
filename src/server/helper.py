...
### Google
auth_uri = CRAFT_HUB_URL + '/v1/auth/google?x-craft-ai-app-id=' + SAC_APP_ID + '&x-craft-ai-app-secret=' + SAC_APP_SECRET + '&success_uri=' + URL + '/run&failure_uri=' + URL + '?failure=true'
